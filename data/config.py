...
COCO_CLASSES = ( "airplane", "ship", "storage_tank", "baseball_diamond","tennis_court","basketball_court","ground_track_field","harbor","bridge","vehicle")
...
vhr_dataset = dataset_base.copy({
    'name': 'vhr_dataset',

    'train_images': '/home/mot_1/segmentation/efficientdet/data/original/images/train/',
    'train_info':   '/home/mot_1/segmentation/efficientdet/data/original/annotations/instances_train.json',

    'valid_images': '/home/mot_1/segmentation/efficientdet/data/original/images/val/',
    'valid_info':   '/home/mot_1/segmentation/efficientdet/data/original/annotations/instances_val.json',
...
yolact_base_config = coco_base_config.copy({
    ...
    # Dataset stuff
    'dataset': vhr_dataset,
    'num_classes': len(vhr_dataset.class_names) + 1,

    # Image Size
    # resizing is done in utils/augmentations.py#L129
    'max_size': None, # NONE if W X H : 600 X 1000,  Efficiendet(efficientnet-b1)+yolact: 512 ,Yolact: 550
