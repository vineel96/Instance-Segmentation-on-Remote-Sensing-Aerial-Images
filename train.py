...
def train():
    ...
    if args.resume is not None:
        ...
        pass  # initialize pretrained weights for Resnet101 backbone of Yolact
    ...
    yolact_net(torch.zeros(1, 3, 896,896).cuda())  #changed
...
def prepare_data(datum, devices:list=None, allocation:list=None):
    with torch.no_grad():
        ...
        #print("*** before images:",images[0:0])

        for device_idx, alloc in enumerate(allocation):
            #print("***images:",images[cur_idx:cur_idx+alloc])
            #print("*** cur_idx:",cur_idx,alloc)
