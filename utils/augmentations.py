...
class Resize(object):
    ...
    def calc_size_preserve_ar(img_w, img_h, max_size):
        ...
        w = max_size[0] * ratio  #changed
        h = max_size[1] / ratio  #changed
        return int(w), int(h)

    def __init__(self, resize_gt=True):
        self.resize_gt = resize_gt
        self.max_size = [896, 896] #[W, H]   #cfg.max_size
    ...
    def __call__(self, image, masks, boxes, labels=None):
        ...
        if self.preserve_aspect_ratio:
            ...
            width, height = self.max_size[0], self.max_size[1]   #changed
...
class FastBaseTransform(torch.nn.Module):
    ...
    def forward(self, img):
        ...
        if cfg.preserve_aspect_ratio:
            ...
            img_size = (896, 896)  # (cfg.max_size, cfg.max_size) #changed
...
class SSDAugmentation(object):
    ...
    def __init__(self, mean=MEANS, std=STD):
        self.augment = Compose([
            ...
            Resize(),
            enable_if(not cfg.preserve_aspect_ratio, Pad(896, 896, mean)), #(cfg.max_size, cfg.max_size) #changed
            ToPercentCoords(),
